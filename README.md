...
|   |   |-- module_GRU.py             # GRU model training, evaluation, prediction
|   |   |-- module_TCN.py             # TCN model training, evaluation, prediction
...
- **Source/Modules/** -- Contains Python modules for pose estimation, model training/testing (LSTM, GRU, TCN), and data visualization.
...
| Model | Test | Date | Accuracy | Macro Precision | Macro Recall | Macro F1 | Weighted F1 |
|-------|------|------|----------|-----------------|--------------|----------|-------------|
| **LSTM (Bidirectional)** | Test03 | 2026-03-23 | **29.9%** | 0.222 | 0.228 | 0.225 | **0.295** |
| **TCN** | Test01 | 2026-03-23 | **29.9%** | **0.234** | **0.249** | **0.237** | **0.295** |
| GRU (Bidirectional) | Test01 | 2026-03-23 | 26.8% | 0.210 | 0.224 | 0.214 | 0.261 |
...
- The **LSTM** and **TCN** achieve comparable performance (29.9% accuracy), with the TCN showing slightly better macro F1 (0.237 vs 0.225) due to more balanced predictions across classes.
